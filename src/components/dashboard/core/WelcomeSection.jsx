    ...
    return (
        ...
        >
            ...
            <div className="relative z-10">
                <h2 className={`text-[18px] md:text-[24px] font-headings font-bold mb-1 transition-colors ${isDarkMode ? 'text-white' : 'text-dark'}`}>
